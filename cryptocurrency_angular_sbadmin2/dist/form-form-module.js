...
module.exports = "<div [@routerTransition]>\n    <h2 class=\"page-header\">글쓰기</h2>\n    <hr>\n    <div class=\"row\">\n        <div class=\"col-lg-8\">\n            <div class=\"form-group input-group\">\n                <div class=\"input-group-prepend\">\n                    <span class=\"input-group-text\" id=\"basic-addon1\">제목</span>\n                </div>\n                <!-- <span class=\"input-group-addon\">@</span> -->\n                <input type=\"text\" class=\"form-control\" #title>\n            </div>\n            <fieldset class=\"form-group\">\n                <textarea class=\"form-control\" rows=\"14\" #contents></textarea>\n            </fieldset>\n        </div>\n    </div>\n    <p>\n        <button type=\"button\" class=\"btn btn-info\" (click)=\"save(title.value, contents.value)\">저장</button>\n    </p>\n</div>\n"
...
/* harmony import */ var _services_board_board__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/board/board */ "./src/app/services/board/board.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FormComponent = /** @class */ (function () {
    ...
    FormComponent.prototype.save = function (title, contents) {
        console.log(title, localStorage.getItem('login_email'), contents);
        this.service.addBoard(new _services_board_board__WEBPACK_IMPORTED_MODULE_3__["Board"](0, title, localStorage.getItem('login_email'), 0, null, contents))
...
/***/ "./src/app/services/board/board.ts":
/*!*****************************************!*\
  !*** ./src/app/services/board/board.ts ***!
  \*****************************************/
...
var Board = /** @class */ (function () {
    function Board(num, title, email, readCount, writedate, content) {
        this.num = num;
        this.title = title;
        this.email = email;
